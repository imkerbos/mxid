...
// ExternalLoginInput is the data the external-IdP gateway hands to ResolveExternalLogin
// after a successful OAuth exchange. Mirrors externalidp.ExternalIdentity but
// kept package-local so user/ does not import externalidp/ (would create a
// cycle once authn wires both together).
