...
var consoleProtectedRoutes = [][2]string{
	...
	{http.MethodGet, "/api/v1/console/apps/env-options"},
	...
	{http.MethodPost, "/api/v1/console/app-groups/:id/access-policies/batch"},
	...
	{http.MethodPost, "/api/v1/console/users/:id/restore"},
